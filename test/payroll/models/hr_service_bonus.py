...
class HrServiceBonus(models.Model):
    ...
    _description = 'Prima De Servicios'
    ...
    line_ids = fields.One2many("hr.service.bonus.line", "service_id", string="Líneas de la prima de servicios")
...
# ========================
    ...
    def _get_line_vals(self, concept):
        ...
        totals = self.env["hr.payroll.mixin"]._compute_service_bonus_days(unpaid_events, self.contract_start_date, self.cutoff_date, totals)
